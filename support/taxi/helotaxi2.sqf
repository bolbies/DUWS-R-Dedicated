calltaxi = {
    ...
    if (0 == _foundPickupPos select 0 && 0 == _foundPickupPos select 1) exitWith {hint "No valid LZ nearby"; sleep 5; _art = [player,"helo_taxi2"] call BIS_fnc_addCommMenuItem;};
    ...
    helotax2 = [player,"helo_taxi2"] call BIS_fnc_addCommMenuItem;
    helotax2 = helotax2;
    }; 
    // ****************************************************
...
taxi = {
    ...
    // helo lock false;
    _s1 = helo turretUnit [3];
    _s2 = helo turretUnit [4];
...
start = {
    ...
    helo = createVehicle ["kyo_MH47E_Ramp", [_hqpos select 0, (_hqpos select 1)+2000, 200],[], 0, "FLY"];
