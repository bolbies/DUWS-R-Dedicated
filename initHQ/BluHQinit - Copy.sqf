...
//_trgWarning setTriggerStatements["this","PAPABEAR sidechat 'This is HQ, there are enemies near our main base!'; playSound 'siren'", ""]; //[nil,nil,rplaySound,"siren"] call RE;
...
_zones_create = [50, 0.2] execVM "initZones\locatorZonesV2.sqf";   // CHECK IF ZONES HAVE ALREADY BEEN PLACED
};
