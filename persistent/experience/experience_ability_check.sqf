		 ...
		 waitUntil {sleep 2; experience_total>=30};          
          ...
          player createDiaryRecord ["abilities_info", ["Field Repair", "<font color='#FF0000'>Cooldown: 5 Minutes</font color><br/>Description:<br/>When activated through the radio menu, the vehicle in wich you are inside will be repaired, and a little bit of fuel added."]];
