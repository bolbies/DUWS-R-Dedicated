...
_u2 = _g1 createUnit [typeOf _u1, position player, [], 0, "FORM"];
_keep_ammocount = [_u1,2,false,[true]] call bis_fnc_param;
...
deleteVehicle _u1;
[_u2] joinSilent player;
deleteGroup _g1;
_u2 addaction ["<t color='#99ff00'>Fix Unit</t>","scripts\test2.sqf", "", 0, true, true, "", "_this == player"];
_dummy = [_u2, (units group this)] execVM ""scripts\automedic.sqf"";", _skill, "private"] ;